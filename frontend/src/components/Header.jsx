export default function Header({ activeCount, completedCount, theme, onToggleTheme, todoCount }) {
  return (
    <>
      <div className="flex items-center justify-between mb-2">
        <div>
          <h1 className="text-4xl font-black tracking-tight text-base-content">my tasks</h1>
